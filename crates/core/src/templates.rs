...
如果输入信息不足，可在对应小节注明\"暂无\"。"
                .to_string(),
            user_prompt_hint: "请撰写一份结构清晰的中文工作日报，至少包含以下小节：\n\
1. 今日完成\n\
2. 进行中\n\
3. 明日计划\n\
4. 风险 / 问题\n\
...
输出仅使用项目符号，不要写小节标题，不要套话。"
                .to_string(),
            user_prompt_hint: "请用 5 行以内的项目符号总结今天的工作。\
每行不超过 30 个汉字，突出动词与产出，不要补充说明，不要使用任何小节标题。"
                .to_string(),
        },
        ReportTemplate {
